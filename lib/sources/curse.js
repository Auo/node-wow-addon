...
module.exports = {
  ...
  search: function search(name, cb) {
    ...
    cloudscraper(url).then(body => {
      cb(null,this._getSearchResults(body))
    }).catch(err => {
      return cb(err, null)
    })
  },
  ...
  getCategories: function (cb) {
    cloudscraper(`${ROOTURL}/wow/addons`).then(body => {
      ...
      return cb(new Error('Could not find categories', err), null)
    })
  },
